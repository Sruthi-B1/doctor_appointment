...
<?php
   ...
   $ar=mysqli_query($al, "SELECT * FROM appointment INNER join doct USING (doct_id)INNER join patient USING (pat_id) order by appo_id DESC ");
   
$i=1;

    ?>
<form method="post" >
<h2 align="center"><b> View Appointment History</b></h2>
